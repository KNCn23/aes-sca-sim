...
static void mix_columns(uint8_t s[16]) {
    for (int c = 0; c < 4; c++) {
        ...
        uint8_t b0 = xtime(a0 ^ a1) ^ a1 ^ a2 ^ a3;
        uint8_t b1 = a0 ^ xtime(a1 ^ a2) ^ a2 ^ a3;
        uint8_t b2 = a0 ^ a1 ^ xtime(a2 ^ a3) ^ a3;
        uint8_t b3 = xtime(a3 ^ a0) ^ a0 ^ a1 ^ a2;
